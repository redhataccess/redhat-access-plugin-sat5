(function() {
    ...
    RHA_INSIGHTS.UTILS.isOnInsightsEnabledPage = function() {
        var response = false;
        if (RHA_INSIGHTS.UTILS.isOnSystemListPage() || RHA_INSIGHTS.UTILS.isOnSystemDetailsPage() || RHA_INSIGHTS.UTILS.isOnSystemOverviewPage() || RHA_INSIGHTS.UTILS.isOnAdminPage() || RHA_INSIGHTS.UTILS.isOnInsightsOverviewPage() || RHA_INSIGHTS.UTILS.isOnSystemTabPage()) {
            response = true;
        }
        return response;
    };
