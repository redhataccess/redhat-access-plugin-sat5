(function() {
    ...
    RHA_INSIGHTS.UTILS.isOnSystemListPage = function() {
        if (RHA_INSIGHTS.UTILS.isOnPage(SYSTEM_PAGE_URLS.SYSTEMS) || RHA_INSIGHTS.UTILS.isOnPage(SYSTEM_PAGE_URLS.PHYSICAL) || RHA_INSIGHTS.UTILS.isOnPage(SYSTEM_PAGE_URLS.OUT_OF_DATE) || RHA_INSIGHTS.UTILS.isOnPage(SYSTEM_PAGE_URLS.REQUIRING_REBOOT) || RHA_INSIGHTS.UTILS.isOnPage(SYSTEM_PAGE_URLS.UNGROUPED) || RHA_INSIGHTS.UTILS.isOnPage(SYSTEM_PAGE_URLS.INACTIVE) || RHA_INSIGHTS.UTILS.isOnPage(SYSTEM_PAGE_URLS.RECENTLY_REGISTERED) || RHA_INSIGHTS.UTILS.isOnSystemOverviewPage()) {
            return true;
        } else {
            return false;
        }
